import './about.css'
import Abut from '../../assets/avatar-2.svg';
  ...
  return (
    <section className="about container section" id="about">
      ...
      <div className="about-container grid">
        <img src={Abut} alt="" className="about-img" />

        <div className="about-data grid">
          <div className="about-info">
            <p className="about-description">I am Bolby Doe, web developer from London, United Kingdom. I have rich experience in web site design and building and customization, also I am good at WordPress.</p>
